<div class="card col-12 col-xl-4 mx-2 my-4">
    <a href="#" data-toggle="modal" data-target="#fixupLaravel" data-bs-toggle="modal" data-bs-target="#fixupLaravel">
        <img src="/img/portfolio/fixup_home.png" class="card-img-top" alt="FIXUP - FRONTEND - LARAVEL">
    </a>
    <div class="card-body">
        <h5 class="card-title">
            <a href="#" data-toggle="modal" data-target="#fixupLaravel" data-bs-toggle="modal" data-bs-target="#fixupLaravel">
                FIXUP - FRONTEND - LARAVEL
            </a>
        </h5>
        <p class="card-text">
    ...
    <div class="modal-dialog modal-xl modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center">FIXUP - FRONTEND - LARAVEL</h5>
